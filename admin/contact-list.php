        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row" style="margin-top: 30px;">
                    <div class="col-sm-10">
                        <h4 class="m-t-0 header-title"><b>Contact List</b></h4>
                    </div>
                </div>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="contact-list.php?id=<?php echo $rows['id'] ?>" class="remove-row" style="color: #f05050;" data-toggle="tooltip" data-placement="top" title="Delete Students" data-original-title="Delete Students"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
