...
session_start();
$civilcount = 0;
$result = mysqli_query($conn, "SELECT * FROM `civil_enginnering`");
?>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="civil_enginnering.php"><span class="color-front" style=margin-left:10px><strong>Civil Engineering</strong></span></a></li>
        </ol>
    </nav>
    ...
    <div class="important">
        <p>* The credit points assigned for extracurricular and or co-curricular activities shall be given by & bpc;the
            ...
            be
            defined by the colleges from time to time.<br />
            <br>
        ...
        <div class="accordion" id="accordionExample">
            <div class="card my-1 faqcard ">
                <div class="card-header collapsed dropdown-toggle" id="faq-1" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <strong>Can I Join as a Civil Engineer After 10th?</strong>
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="faq-1" data-parent="#accordionExample">
                    <div class="card-body">
                        Yes, you can do Civil Engineering after 10th…. You have to give a JEXPO exam and according to ur
                        rank you
                        will
            ...
            <div class="card my-1 faqcard">
                <div class="card-header dropdown-toggle" id="faq-3" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <strong>Should I have to know drawing before joining these course</strong>
                </div>
                <div id="collapseThree" class="collapse" aria-labelledby="faq-3" data-parent="#accordionExample">
                    <div class="card-body">
                        No its not necessary to know this.
                    </div>
                </div>
            </div>
            <div class="card my-1 faqcard">
