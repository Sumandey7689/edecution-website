...
session_start();
$Cstcount = 0;
$result = mysqli_query($conn, "SELECT * FROM `computer_sciencetechnology`");
?>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="computer_sciencetechnology.php"><span class="color-front" style=margin-left:10px><strong>Computer Science Technology</strong></span></a></li>
        </ol>
    </nav>
    ...
    <div class="important">
        ...
        <p><strong>4.</strong> <strong>Practice School </strong>In the V semester, every candidate shall undergo
            practice school for a period of 150 hours evenly
            distributed <br> throughout the semester. The student shall opt any one of the domains for practice school
        ...
        <div class="accordion" id="accordionExample">
            <div class="card my-1 faqcard ">
                <div class="card-header collapsed dropdown-toggle" id="faq-1" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <strong>Can I Join as a Computer Engineer After 10th?</strong>
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="faq-1" data-parent="#accordionExample">
                    <div class="card-body">
                        Yes, you can do Computer Engineering after 10th…. You have to give a JEXPO exam and according to
                        ur rank you
                        will
