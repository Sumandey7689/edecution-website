...
session_start();
$Eecount = 0;
$result = mysqli_query($conn, "SELECT * FROM `electrical_engineering`");
?>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="electrical_engineering.php"><span class="color-front" style=margin-left:10px><strong>Electrical Engineering</strong></span></a></li>
        </ol>
    </nav>
        ...
        <div class="accordion" id="accordionExample">
            <div class="card my-1 faqcard ">
                <div class="card-header collapsed dropdown-toggle" id="faq-1" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <strong>Can I Join as a Electrical Engineering After 10th?</strong>
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="faq-1" data-parent="#accordionExample">
                    <div class="card-body">
                        Yes, you can do Electrical Engineering after 10th…. You have to give a JEXPO exam and according
                        to ur rank you will get admission in engineering college.
                    </div>
                </div>
            </div>
            <div class="card my-1 faqcard">
