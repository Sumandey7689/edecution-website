...
session_start();
$Etcount = 0;
$result = mysqli_query($conn, "SELECT * FROM `electronics_enginnering`");
?>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="electronics_enginnering.php"><span class="color-front" style=margin-left:10px><strong>Electronics Engineering</strong></span></a></li>
        </ol>
    </nav>
    ...
    <div class="important">
        ...
        <p><strong>2. Project work</strong> All the students shall undertake a project under the supervision of a
            teacher
            and submit a report. The area of the project shall be decided by the supervisor in consultation with the
            student.
            The project may be carried out in group not exceeding 3 in number. The internal and external examiner
            appointed by
            the University shall evaluate the project at the time of the Practical examinations of other semester(s).
        </p>
        <p><strong>3.</strong> <strong>Industrial training (Desirable)</strong> Every candidate shall be required to
            work
            for at least 150 hours spread over four weeks in a Industry.After the Semester &ndash; VI and before the
            commencement of Semester &ndash; III, and shall submit satisfactory report of such work and certificate duly
            signed by the authority of training organization to the head of the institute.</p>
        <p><strong>4.</strong> <strong>Practice School </strong>In the V semester, every candidate shall undergo
            practice
            school for a period of 150 hours evenly<br />
            distributed throughout the semester. The student shall opt any one of the domains for practice school
            declared by
            the academic (program) committee from time to time.<br />
            At the end of the practice school, every student shall submit a printed report (in triplicate) on the
            practice
            school he/she attended (not more than 25 pages). Along with the exams of semester VII, the report submitted
            by the
            student. The knowledge and skills acquired by the student through practice school shall<br />
        ...
        <div class="accordion" id="accordionExample">
            <div class="card my-1 faqcard ">
                <div class="card-header collapsed dropdown-toggle" id="faq-1" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                    <strong>Can I Join as a Electronics Engineer After 10th?</strong>
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="faq-1" data-parent="#accordionExample">
                    <div class="card-body">
                        Yes, you can do Electronics Engineering after 10th…. You have to give a JEXPO exam and according
                        to
            ...
            <div class="card my-1 faqcard">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="faq-3" data-parent="#accordionExample">
                    <div class="card-body">
                        Yes its necessary because the Average diploma Engineer salary is too low. If you will pass
                        b.tech then the salary will increase very high & you get much better opportunities.
                    </div>
                </div>
            </div>
            <div class="card my-1 faqcard">
